...
Note that the one-line installation script is for Teleport versions 17.3 and
above. If you are installing a version before this edition or this script does
not work on your server, see below for other options.**

</Admonition>

Teleport Agents should always use the one-line installation script or
`teleport-update` binary to install Teleport. Otherwise, they will fall
