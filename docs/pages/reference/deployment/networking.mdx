...
group private_net3(carbon-virtual-private-cloud)[Private Network]
group k8s_net(logos-kubernetes)[Kubernetes Cluster] in private_net3
...
service k8s_agent_external(teleport-logo-purple)[External Teleport Agent with Kubeconfig] in private_net3
...
%% Control plane and edge connections
user:R -- L:j_usr_buf
j_usr_buf:R --> L:proxy
...
k8s_agent_external:R --> L:k8s_pods
