...
Write AWS profiles retrieved from the AWS IAM Identity Center integration to the AWS config file.
...
|`--dry-run`|`false`|Print the configuration that will be applied without modifying the AWS config file.|
